...
module.exports.config = {
    ...
    envConfig: {
        ...
        key: "FI6bX3kC" //reg key: https://www.nguyenmanh.name.vn/docs
...
module.exports.run = async ({
    ...
    try {
        ...
        let os = (await axios.get(encodeURI(`https://www.nguyenmanh.name.vn/api/tikSearch?query=${search}&apikey=FI6bX3kC`))).data
