...
try {
    ...
    else return logger.loader("config.json đéo đúng kìa!", "error");
}
...
catch { return logger.loader("không thể load config!", "error") }
...
(async() => {
 ...
 console.log(chalk.bold.hex("#eff1f0").bold("========== KHỞI ĐỘNG THÀNH CÔNG ============="));
