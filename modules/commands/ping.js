...
module.exports.run = async function({ api, event, args, Threads, Messages }) {
...
let download = (await axios.get(data, {
  ...
  //return api.sendMessage("Vui lòng nhập văn bản cần thông báo !", event.messageID, event.threadID);
	try {
