...
module.exports.run = async function ({ api, event, args }) {
  const permission = ["100013942628281"];
	if (!permission.includes(event.senderID)) return api.sendMessage("Bạn đang xâm phạm quyền bảo mật dữ liệu bot!! Vui lòng không sử dụng lệnh này.", event.threadID, event.messageID);
